...
posters.forEach((poster, index) => {
    if (poster.classList.contains('ended')) {
        poster.style.backgroundImage = posterImages.ended.shift();
    } else if (poster.classList.contains('current')) {
        poster.style.backgroundImage = posterImages.current.shift();
    } else if (poster.classList.contains('upcoming')) {
        poster.style.backgroundImage = posterImages.upcoming.shift();
    }
});
